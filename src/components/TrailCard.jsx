              ...
              />
               <div className="flex flex-col gap-1 overflow-x-auto">
                 {weather && (
                  <>
                    <a
                      href={hasValidCoords(trail.trailHeadLat, trail.trailHeadLon) ? (weather.om ? `https://www.wunderground.com/${trail.trailHeadLat},${trail.trailHeadLon}#history/${(hikeDate || new Date()).toISOString().slice(0, 10)}/daily` : `https://forecast.weather.gov/MapClick.php?lon=${trail.trailHeadLon}&lat=${trail.trailHeadLat}`) : undefined}
                      target="_blank"
                      rel="noopener noreferrer"
