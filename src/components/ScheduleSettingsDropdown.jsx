...
export default function ScheduleSettingsDropdown() {
  ...
  const scheduleTab = (
    <div className="max-h-[70vh] overflow-y-auto">
      ...
      >
        ...
        Clear Schedule {!hasApiKey && '(need API key)'}
      </button>
    </div>
  );
  ...
  const aboutTab = (
    <div className="max-h-[84vh] overflow-y-auto py-3 px-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      ...
      <div className="mb-4">
        <p className="text-base font-semibold text-gray-500 uppercase tracking-wider mb-2">Legend</p>
        <dl className="text-base text-gray-700 space-y-2">
          ...
          <div><dt className="inline font-mono font-semibold">◆</dt><dd className="inline"> — wilderness trail (limit 12 hikers in group)</dd></div>
      ...
      <a
        ...
        className="text-lg text-green-700 hover:text-green-900 hover:underline flex items-center gap-2"
      >
  ...
  return (
    <div className="relative" data-settings-root>
      ...
      {showSettings && (
        <div id="schedule-settings-menu" className="absolute top-full right-0 mt-1 bg-white rounded-lg shadow-xl border border-gray-200 p-2 w-80 z-50">
