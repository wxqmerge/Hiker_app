import { MONTH_NAMES } from './constants';
 ...
 export function getGroupName() {
   return import.meta.env.VITE_SCHEDULE_NAME || 'default';
 }
 
 /**
  * Parse the configured hike days from environment variables.
  * VITE_HIKE_DAYS should be a comma-separated list of day indices (0=Sun, 6=Sat).
  ...
  */
  ...
  export function getHikeDays() {
    const daysStr = import.meta.env.VITE_HIKE_DAYS || '3,5'; // Default to Wed/Fri
  ...
  export function getHikeDaysLabel() {
    const daysStr = import.meta.env.VITE_HIKE_DAYS || '3,5';
